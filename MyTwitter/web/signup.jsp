...
<html>
    ...
    <h1>Sign Up Here</h1>
        ...
        <p>To use MyTwitter, please sign up below:</p>
        <p><i>${message}</i></p>
        ...
        <form action="membership" method="post">
            ...
            <input type="password" name="password" value="${user.password}" min="7" required><br>

            <label class="pad_top">Birthdate</label><br>
            <label class="pad_top">(mm/dd/yyyy):</label>
                <select name="month" value ="${user.month}" required>
                    <option value=""></option>
                ...
                <select name="day" value="${user.day}" required>
                    <option value=""></option>
                    <option value="1">01</option>
                    <option value="2">02</option>
                    <option value="3">03</option>
                ...
                <select name="year" value="${user.year}" required>
                    <option value=""></option>
